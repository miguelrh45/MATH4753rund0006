#' My norm function
#'
#' @param x data to be passed through
#' @param mu mean
#' @param sig standard deviation
#' @param ... alternate arguments
#'
#' @return graph of maximum likelihood
#' @export
#'
#' @examples mynormfunction(x=c(5,7,7,8,10),mu=seq(5,10,length=1000),sig=seq(0.1,4,length=1000),lwd=2,labcex=1)
mynormfunction=function(x,mu,sig,...){  #x sample vector
